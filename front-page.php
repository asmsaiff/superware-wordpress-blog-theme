    ...
    <div class="container">
        ...
        <section class="recent-posts">
            ...
            <div class="card-columns listrecent">
                ...
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/img/demopic/10.jpg"
                            alt="">
                    </a>
                    <div class="card-block">
                ...
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid"
                            src="<?php echo get_template_directory_uri(); ?>/assets/img/demopic/5.jpg" alt="">
                    </a>
                    <div class="card-block">
                ...
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid"
                            src="<?php echo get_template_directory_uri(); ?>/assets/img/demopic/9.jpg" alt="">
                    </a>
                    <div class="card-block">
                ...
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid"
                            src="<?php echo get_template_directory_uri(); ?>/assets/img/demopic/6.jpg" alt="">
                    </a>
                    <div class="card-block">
